...
#inputs from command line call 

experiment_folder = str(sys.argv[1])
#print(experiment_folder)
to_run_start = int(sys.argv[2])
#print(to_run_start)
to_run_end = int(sys.argv[3])
#print(to_run_end)

experiment_files = sorted(glob.glob(experiment_folder+'/msCam*.avi'))
print(experiment_files)

files_to_run = experiment_files[to_run_start:to_run_end]

print('running files: ' + f for f in files_to_run)
